...
#SBATCH --output=/private/home/oceanntwt/contriever/logtrain/%A
...
TDIR=/private/home/oceanntwt/contriever/encoded-data/bert-base-multilingual-cased/
...
srun ~oceanntwt/anaconda3/envs/pytorch10/bin/python3 ~oceanntwt/contriever/train.py \
        --model_path $mp \
        ...
        --output_dir /checkpoint/oceanntwt/contriever/xling/$name \
        --main_port $port \
